...
//--------------------------------------------------------------
//emergency phone number with country code 9938672836
const String EMERGENCY_PHONE = "+919937663546";
//--------------------------------------------------------------
...
unsigned long alert_delay = 5000; //30 seconds
//--------------------------------------------------------------
...
void setup()
{
  ...
  xaxis = map(ax, -17000, 17000, 0, 255 ); 
  yaxis = map(ay, -17000, 17000, 0, 255 ); 
  zaxis = map(az, -17000, 17000, 0, 255 ); 
  //--------------------------------------------------------------
}
    ...
    //--------------------------------------------------------------
      ...
      if(buff.indexOf(EMERGENCY_PHONE) > 1){
        ...
        if(buff.indexOf("get gps") > 1){
          getGps();
          String sms_data;
          sms_data = "GPS Location Data Of your Vehicle\r";
...
void getGps()
{
  ...
  if (newData) //If newData is true
  {
    ...
    newData = false;
    if (latitude == "0.000000" && longitude == "0.000000") //If latitude and longitude are zero
     {
     latitude = "19.8048861";
     longitude = "85.8344825";
    }
